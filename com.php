...
if($_SERVER['REQUEST_METHOD']=='GET'){
    if(isset($_GET['IDPUB'])){
        ...
        $query="SELECT publicaciones.IDPUB, usuarios.NOMBRE, usuarios.APELLIDO, publicaciones.FECHAHORAP, publicaciones.DESCRIPCIONP, publicaciones.IMAGENP, publicaciones.CONTADORLIKE, publicaciones.EXISTE 
        FROM usuarios 
